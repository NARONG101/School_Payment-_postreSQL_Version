...
<head>
    ...
    <title>@yield('title', 'CK Takhmao School') — CK Takhmao School</title>
    <link rel="icon" type="image/x-icon" href="/favicon.ico">
    {{-- Kantumruy Pro: handles Khmer characters typed into any input field --}}
...
<aside class="sidebar" id="sidebar" role="navigation" aria-label="Main navigation">
    <div class="sidebar-brand">
        ...
        <div style="text-align:center;padding:4px 0 14px">
            <img src="/logo.png?v={{ time() }}" alt="CK Logo"
                 style="width:110px;height:auto;max-height:72px;object-fit:contain;display:block;margin:0 auto 8px;background:transparent;border:none;box-shadow:none;">
